...
import 'package:animal_detection/animal_detection.dart' show ImageUtils;
import 'package:dog_detection/dog_detection.dart'
    show prepareCameraFrameFromImage;
import 'package:flutter/foundation.dart'
    show debugDefaultTargetPlatformOverride, TargetPlatform;
import 'package:flutter_test/flutter_test.dart';

/// Runs the desktop half of `DogDetector.detectFromCameraImage` without a
/// model: pack the frame with `prepareCameraFrameFromImage`, passing `isBgra`
/// through as the detector does, then decode it with the same
/// `ImageUtils.cameraFrameToBgrMat` the detector's worker uses.
void main() {
